...
class ProjectService:
    ...
    async def set_pinned(self, project_id: UUID, user: User, is_pinned: bool) -> Project:
        return await self.repository.set_pinned(await self.accessible(project_id, user), is_pinned)
